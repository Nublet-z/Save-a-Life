...
# Streamlit App
def main():
    st.title("Cancer Detection from Medical Images")

    st.write("""
    Upload a medical image, and this app will predict the likelihood of cancer based on the provided model.
    """)
    ...
    if uploaded_file is not None:
        ...
        if processed_image is not None:
            ...
            st.write(f"Predicted: **{CLASS_NAMES[prediction]}**")
